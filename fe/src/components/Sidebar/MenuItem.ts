        ...
        children: [
          {
            ...
            route: '/aset-lancar/Perintaan-Barang/Entri-Permintaan-Barang',
            isActive: isActiveRoute('/aset-lancar/Perintaan-Barang/Entri-Permintaan-Barang'),
            children: [],
          },
          {
            id: 1,
            title: 'Usulan Permintaan Barang',
            route: '/aset-lancar/Perintaan-Barang/Usulan-Permintaan-Barang',
            isActive: isActiveRoute('/aset-lancar/Perintaan-Barang/Usulan-Permintaan-Barang'),
            children: [],
          },
          {
            id: 3,
            title: 'Persetujuan Barang',
            route: '/aset-lancar/Perintaan-Barang/Persetujuan-Barang',
            isActive: isActiveRoute('/aset-lancar/Perintaan-Barang/Persetujuan-Barang'),
            children: [],
          },
          {
            id: 4,
            title: 'BAST Penyaluran Barang',
            route: '/aset-lancar/Perintaan-Barang/BAST-Penyaluran-Barang',
            isActive: isActiveRoute('/aset-lancar/Perintaan-Barang/BAST-Penyaluran-Barang'),
            children: [],
          },
        ],
      },
        ...
        children: [
          {
            ...
            route: '/aset-lancar/Laporan/Laporan-Pengadaan',
            isActive: isActiveRoute('/aset-lancar/Laporan/Laporan-Pengadaan'),
            children: [],
          },
          {
            id: 2,
            title:'Laporan Penyaluran',
            route: '/aset-lancar/Laporan/Laporan-Penyaluran',
            isActive: isActiveRoute('/aset-lancar/Laporan/Laporan-penyaluran'),
            children: [],
          },
          {
            id: 3,
            title:'Laporan Persediaan (IV.1)',
            route: '/aset-lancar/Laporan/Laporan-persediaan.iv.1',
            isActive: isActiveRoute('/aset-lancar/Laporan/Laporan-persediaan.iv.1'),
            children: [],
          },
          {
            id: 4,
            title:'Laporan Persediaan Rusak (IV.I)',
            route: '/aset-lancar/Laporan/Laporan-Persediaan-Rusak.iv.i',
            isActive: isActiveRoute('/aset-lancar/Laporan/Laporan-Persediaan-Rusak.iv.i'),
            children: [],
          },
          {
            id: 5,
            title:'Laporan Barang Milik Daerah (IV.L1)',
            route: '/aset-lancar/Laporan/Laporan-Barang-Milik-Daerah.IV.L1',
            isActive: isActiveRoute('/aset-lancar/Laporan/Laporan-Barang-Milik-Daerah.IV.L1'),
            children: [],
          },
        ]
      },
    ...
    children: [
      {
        id: 1,
        title: 'Saldo Barang',
        isActive: isActiveRoute('/aset-tetap/saldo-barang'),
        children: [
          {
            id: 1,
            title: 'Data Awal',
            isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal'),
            children: [
              {
                id: 1,
                title: 'Tanah',
                route: '/aset-tetap/saldo-barang/data-awal/tanah',
                isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal/tanah'),
                children: [],
              },
              {
                id: 2,
                title: 'Peralatan Mesin',
                route: '/aset-tetap/saldo-barang/data-awal/peralatan-mesin',
                isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal/peralatan-mesin'),
                children: [],
              },
              {
                id: 3,
                title: 'Gedung dan Bangunan',
                route: '/aset-tetap/saldo-barang/data-awal/gedung-dan-bangunan',
                isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal/gedung-dan-bangunan'),
                children: [],
              },
              {
                id: 4,
                title: 'Jalan, Irigasi dan jaringan',
                route: '/aset-tetap/saldo-barang/data-awal/jalan-irigasi-jaringan',
                isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal/jalan-irigasi-jaringan'),
                children: [],
              },
              {
                id: 5,
                title: 'Aset Tetap Lainnya',
                route: '/aset-tetap/saldo-barang/data-awal/aset-tetap-lainnya',
                isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal/aset-tetap-lainnya'),
                children: [],
              },
              {
                id: 6,
                title: 'Aset Lain-lain',
                route: '/aset-tetap/saldo-barang/data-awal/aset-lain-lain',
                isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal/aset-lain-lain'),
                children: [],
              },
              {
                id: 7,
                title: 'Konstruksi Dalam Pengerjaan',
                route: '/aset-tetap/saldo-barang/data-awal/konstruksi-dalam-pengerjaan',
                isActive: isActiveRoute('/aset-tetap/saldo-barang/data-awal/konstruksi-dalam-pengerjaan'),
                children: [],
              },
            ]
          },
          {
            ...
            route: '/aset-tetap/saldo-barang/pengunaan-awal',
            isActive: isActiveRoute('/aset-tetap/saldo-barang/pengunaan-awal'),
            children: [],
          },
          {
            id: 3,
            title: 'Pemanfaatan Awal',
            route: '/aset-tetap/saldo-barang/pemanfaatan-awal',
            isActive: isActiveRoute('/aset-tetap/saldo-barang/pemanfaatan-awal'),
            children: [],
          },
          {
            id: 4,
            title: 'Pengamanan Awal',
            route: '/aset-tetap/saldo-barang/pengamanan-awal',
            isActive: isActiveRoute('/aset-tetap/saldo-barang/pengamanan-awal'),
            children: [],
          },
        ],
      },
